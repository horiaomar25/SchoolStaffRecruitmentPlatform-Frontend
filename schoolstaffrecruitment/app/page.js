...
export default function Home() {
  return (
    <main className='flex h-screen'>
      <div className='relative w-1/2 mobile:hidden desktop:block '>
      ...
      <div className='flex flex-col justify-center items-center desktop:w-1/2 mobile:w-full '>
      ...
      <button className="btn btn-wide lg:hover:bg-test ">Login</button>
      </div>
